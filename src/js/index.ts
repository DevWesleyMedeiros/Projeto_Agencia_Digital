...
// let imgTag = document.querySelector(".mockup1") as HTMLImageElement | null;
// if (imgTag) {
...
// const importImages = (require as any).context('../assets/images', false, /\.jpg$/);
// const images: string[] = [];
...
// const imgsTag = Array.from(document.querySelectorAll(".IMGtag")) as HTMLImageElement[];
...
// const arrayLogoParceiros: string[] = [Bianchini, Rancho, Hoepcke, Monguillhot];
// const logosEmpresasParceiras = Array.from(document.querySelectorAll(".logo-empresas-clientes")) as HTMLImageElement[];
...
//   $('.Humburguer_icon').on('click', function (e: JQuery.ClickEvent) {
//     e.stopPropagation();
